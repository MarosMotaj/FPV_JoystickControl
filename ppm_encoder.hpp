#ifndef __PPM_ENCODER_HPP__
#define __PPM_ENCODER_HPP__
...
class PPMEncoder {
  ...
  public:
    ...
    //methods
    virtual void init(uint8_t ppmPinNumber); //call this first to initialise
    virtual void setTXChannel(uint8_t channelNum, uint16_t value); //call this with value between 500uS and 1500uS (channel min/max)
    virtual void timer1CompAInterrupt();
};

extern PPMEncoder ppmEncoder;


#endif // __PPM_ENCODER_HPP__
